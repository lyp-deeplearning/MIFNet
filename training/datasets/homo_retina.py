...
class HomographyDataset(BaseDataset):
    default_conf = {
        # image search
        "data_dir": "retina_mix",  # the top-level directory
        "image_dir": "",  # the subdirectory with the images
        "image_list": "retina_mix.txt",  # optional: list or filename of list
...
class _Dataset(torch.utils.data.Dataset):
    ...
    def _read_view(self, img, H_conf, ps, left=False):
        ...
        # 加入亮度翻转
        #data["image"] = color_vert(data["image"], p=0.7)
